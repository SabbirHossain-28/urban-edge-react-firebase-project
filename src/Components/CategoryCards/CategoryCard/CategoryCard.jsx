          ...
          <div className="flex justify-center border-t-2 border-dashed mb-5">
            <Link to={`/cardDetails/${id}`}>
              <button className="text-xl mt-4 w-48 h-14 text-white bg-[#BB915B] overflow-hidden relative z-10 group hover:text-white duration-700 rounded-md">
                Property Details
                <span className="bg-[#c9a474] group-hover:scale-125 scale-0 ease-in-out duration-300 delay-50 size-32 rounded-full absolute mx-auto my-auto inset-0 -z-10"></span>
                <span className="bg-[#ba986d] group-hover:scale-125 scale-0 ease-in-out duration-300 delay-100 size-28 rounded-full absolute mx-auto my-auto inset-0 -z-10"></span>
                <span className="bg-[#b39166] group-hover:scale-125 scale-0 ease-in-out duration-300 delay-200 size-24 rounded-full absolute mx-auto my-auto inset-0 -z-10"></span>
                <span className="bg-[#b98f5a] group-hover:scale-125 scale-0 ease-in-out duration-300 delay-300 size-20 rounded-full absolute mx-auto my-auto inset-0 -z-10"></span>
                <span className="bg-[#BB915B] group-hover:scale-125 scale-0 ease-in-out duration-300 delay-[400ms] size-16 rounded-full absolute mx-auto my-auto inset-0 -z-10"></span>
              </button>
            </Link>
          </div>
        </div>
